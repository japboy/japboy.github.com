 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */function R(t,e){const{element:{content:s},parts:i}=t,n=document.createTreeWalker(s,j,null,!1);let r=$(i),o=i[r],a=-1,l=0;const c=[];let d=null;for(;n.nextNode();){a++;const t=n.currentNode;for(t.previousSibling===d&&(d=null),e.has(t)&&(c.push(t),null===d&&(d=t)),null!==d&&l++;void 0!==o&&o.index===a;)o.index=null!==d?-1:o.index-l,o=i[r=$(i,r)]}c.forEach(t=>t.parentNode.removeChild(t))}const k=t=>{let e=t.nodeType===Node.DOCUMENT_FRAGMENT_NODE?0:1;const s=document.createTreeWalker(t,j,null,!1);for(;s.nextNode();)e++;return e},$=(t,e=-1)=>{for(let s=e+1;s<t.length;s++){const e=t[s];if(u(e))return s}return-1};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
class K extends Z{update(t){super.update(t);const e=this.render();e instanceof _&&this.constructor.render(e,this.renderRoot,{scopeName:this.localName,eventContext:this})}render(){}}K.render=((t,e,s)=>{const i=s.scopeName,n=A.has(e);if(((t,e,s)=>{let i=A.get(e);void 0===i&&(o(e,e.firstChild),A.set(e,i=new w(Object.assign({templateFactory:V},s))),i.appendInto(e)),i.setValue(t),i.commit()})(t,e,Object.assign({templateFactory:(t=>e=>{const s=F(e.type,t);let i=O.get(s);void 0===i&&(i=new Map,O.set(s,i));let n=i.get(e.strings);if(void 0===n){const s=e.getTemplateElement();U&&window.ShadyCSS.prepareTemplateDom(s,t),n=new p(e,s),i.set(e.strings,n)}return n})(i)},s)),e instanceof ShadowRoot&&U&&t instanceof _){if(!L.has(i)){const t=A.get(e).value;z(e,t.template,i)}n||window.ShadyCSS.styleElement(e.host)}});window.customElements.define("atom-layout-grid",class extends K{static get properties(){return{column:{type:Number}}}constructor(){super()}render(){return M`
    ...
    `}});window.customElements.define("atom-heading",class extends K{static get properties(){return{}}_render(){return M`
      ...
      <h1><slot></slot></h1>
    `}});class Q extends K{constructor(){super()}render(){return M`
      <style>
        :host {
    ...
    `}})}]);
//# sourceMappingURL=app-42caeac.js.map