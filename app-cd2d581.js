 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const C=new class{handleAttributeExpressions(t,e,s,i){const n=e[0];return"."===n?new P(t,e.slice(1),s).parts:"@"===n?[new T(t,e.slice(1),i.eventContext)]:"?"===n?[new x(t,e.slice(1),s)]:new v(t,e,s).parts}handleTextExpression(t){return new w(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */function V(t){let e=A.get(t.type);void 0===e&&(e=new Map,A.set(t.type,e));let s=e.get(t.strings);return void 0===s&&(s=new u(t,t.getTemplateElement()),e.set(t.strings,s)),s}const A=new Map,O=new WeakMap,M=(t,...e)=>new _(t,e,"html",C),k=NodeFilter.SHOW_ELEMENT|NodeFilter.SHOW_COMMENT|NodeFilter.SHOW_TEXT;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */function H(t,e){const{element:{content:s},parts:i}=t,n=document.createTreeWalker(s,k,null,!1);let r=j(i),o=i[r],a=-1,l=0;const c=[];let d=null;for(;n.nextNode();){a++;const t=n.currentNode;for(t.previousSibling===d&&(d=null),e.has(t)&&(c.push(t),null===d&&(d=t)),null!==d&&l++;void 0!==o&&o.index===a;)o.index=null!==d?-1:o.index-l,o=i[r=j(i,r)]}c.forEach(t=>t.parentNode.removeChild(t))}const U=t=>{let e=t.nodeType===Node.DOCUMENT_FRAGMENT_NODE?0:1;const s=document.createTreeWalker(t,k,null,!1);for(;s.nextNode();)e++;return e},j=(t,e=-1)=>{for(let s=e+1;s<t.length;s++){const e=t[s];if(p(e))return s}return-1};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class K extends Z{update(t){super.update(t);const e=this.render();e instanceof _&&this.constructor.render(e,this.renderRoot,{scopeName:this.localName,eventContext:this})}render(){}}K.render=((t,e,s)=>{const i=s.scopeName,n=O.has(e);if(((t,e,s)=>{let i=O.get(e);void 0===i&&(o(e,e.firstChild),O.set(e,i=new w(Object.assign({templateFactory:V},s))),i.appendInto(e)),i.setValue(t),i.commit()})(t,e,Object.assign({templateFactory:(t=>e=>{const s=$(e.type,t);let i=A.get(s);void 0===i&&(i=new Map,A.set(s,i));let n=i.get(e.strings);if(void 0===n){const s=e.getTemplateElement();F&&window.ShadyCSS.prepareTemplateDom(s,t),n=new u(e,s),i.set(e.strings,n)}return n})(i)},s)),e instanceof ShadowRoot&&F&&t instanceof _){if(!q.has(i)){const t=O.get(e).value;L(e,t.template,i)}n||window.ShadyCSS.styleElement(e.host)}});window.customElements.define("atom-layout-grid",class extends K{static get properties(){return{column:{type:Number}}}constructor(){super()}render(){return M`
      <style>
        :host {
    ...
    `}});window.customElements.define("atom-heading",class extends K{static get properties(){return{}}_render(){return M`
      ...
      <h1><slot></slot></h1>
    `}});window.customElements.define("template-home",class extends K{static get properties(){return{messages:{type:Array}}}constructor(){super(),this.messages=["Hey","Hi!","Hello.","Greetings!","Yo","Hola~","Hey","Hi!","Hello.","Greetings!","Yo","Hola~"]}render(){return M`
      <style>
        :host {
    ...
    `}});window.customElements.define("page-home",class extends K{static get properties(){return{}}constructor(){super()}render(){return M`
      <template-home></template-home>
    `}})}]);
//# sourceMappingURL=app-cd2d581.js.map