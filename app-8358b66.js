 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const C=new class{handleAttributeExpressions(t,e,i,s){const n=e[0];return"."===n?new P(t,e.slice(1),i).parts:"@"===n?[new T(t,e.slice(1),s.eventContext)]:"?"===n?[new w(t,e.slice(1),i)]:new y(t,e,i).parts}handleTextExpression(t){return new x(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
